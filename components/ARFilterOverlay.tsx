...
export const AR_FILTERS: ARFilterDef[] = [
  ...
  { id: 'ar_tiger', name: 'Tiger', thumbnail: '🐯' },
  { id: 'ar_bear', name: 'Bear', thumbnail: '🐻' },
  { id: 'ar_unicorn', name: 'Unicorn', thumbnail: '🦄' },
  { id: 'ar_flowers', name: 'Bloom', thumbnail: '🌸' },
  { id: 'ar_sakura', name: 'Sakura', thumbnail: '🌺' },
  { id: 'ar_butterfly', name: 'Flutter', thumbnail: '🦋' },
  { id: 'ar_angel', name: 'Angel', thumbnail: '😇' },
  { id: 'ar_devil', name: 'Devil', thumbnail: '😈' },
  { id: 'ar_crown', name: 'Queen', thumbnail: '👑' },
  { id: 'ar_sunglasses', name: 'Sunnies', thumbnail: '🕶️' },
  { id: 'ar_hearts', name: 'Love', thumbnail: '💖' },
  { id: 'ar_stars', name: 'Star', thumbnail: '⭐' },
  { id: 'ar_rainbow', name: 'Rainbow', thumbnail: '🌈' },
  { id: 'ar_galaxy', name: 'Galaxy', thumbnail: '🌌' },
  { id: 'ar_disco', name: 'Disco', thumbnail: '🪩' },
  { id: 'ar_confetti', name: 'Party', thumbnail: '🎉' },
  { id: 'ar_money', name: 'Money', thumbnail: '💸' },
  { id: 'ar_bubble', name: 'Bubbles', thumbnail: '🫧' },
  { id: 'ar_snow', name: 'Frost', thumbnail: '❄️' },
  { id: 'ar_alien', name: 'Alien', thumbnail: '👽' },
  { id: 'ar_fire', name: 'Fire', thumbnail: '🔥' },
  { id: 'ar_neon', name: 'Neon', thumbnail: '💡' },
];
